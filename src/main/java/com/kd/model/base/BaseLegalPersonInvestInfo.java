...
public abstract class BaseLegalPersonInvestInfo<M extends BaseLegalPersonInvestInfo<M>> extends Model<M> implements IBean {

	/**
	 * 表名
	 */
	public static final String TableName = "legal_person_invest_info";
